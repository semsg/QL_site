...
from learn_dj.models import Article, UserMessage, TextNew, LedMod_GTR2416, ArticleBox
...
def answer(request):
	...
	send_mail(request.POST['name'], request.POST['comment'], request.POST.get('email', 'semensg2014@gmail.com'), ['semensg2014@gmail.com'], fail_silently=False)
